...
public class PlayerMoter : MonoBehaviour
{
	...
	void FaceTarget()
	{
		...
		Quaternion lookRotation = Quaternion.LookRotation(new Vector3(direction.x, transform.rotation = Quaternion.Slerp(transform.rotation, lookRotation, Time.deltaTime * 5f));
	}
}
